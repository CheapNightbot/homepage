...
export function ModeToggle() {
    ...
    return (
        <Button onClick={() => setTheme(theme === "light" ? "dark" : "light")} variant="default" size="icon" className="rounded-full size-5 text-white/85 hover:text-white !bg-transparent w-fit h-fit focus-visible:ring-0">
